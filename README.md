...
# 경력
* [지티원 프리랜서](https://toss.im)
    - AML서비스팀
    - 기간 : 2018.04-
* [지티원(주)](www.gtone.co.kr)
    - AML서비스팀
    - 기간 : 2014.12-2018.04
...
#### 개발
- Java로 구현되어 있는 배치 수정
- Java, JavaScript, jQuery등으로 구현되어 있는 화면 수정 및 추가
...
- Java로 구현되어 있는 배치 수정
- Java, JavaScript, jQuery등으로 구현되어 있는 화면 수정 및 추가
- 솔루션의 BRMINER를 이용하여 컨설팅에서 정의한 거래모니터링 룰을 혐의거래자,혐의거래내역을 SQL쿼리로 구현
- 컨설팅 산출물 분석


### 카카오뱅크 위험기반 RBA고도화프로젝트
`TMS업무, 2018.10-2019.05`
...
- 미니 프로젝트 : 정보계에서 고객파기대상을 프로시저로 테이블에 대상테이블 정의 후 고객정보 파기
